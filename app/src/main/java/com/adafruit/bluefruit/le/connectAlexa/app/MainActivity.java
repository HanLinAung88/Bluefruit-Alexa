...
import com.adafruit.bluefruit.le.connectAlexa.app.neopixel.NeopixelActivity;
import com.adafruit.bluefruit.le.connectAlexa.app.settings.SettingsActivity;
import com.adafruit.bluefruit.le.connectAlexa.app.update.FirmwareUpdater;
import com.adafruit.bluefruit.le.connectAlexa.app.update.ReleasesParser;
import com.adafruit.bluefruit.le.connectAlexa.ble.BleDevicesScanner;
import com.adafruit.bluefruit.le.connectAlexa.ble.BleManager;
import com.adafruit.bluefruit.le.connectAlexa.ble.BleUtils;
import com.adafruit.bluefruit.le.connectAlexa.ui.utils.DialogUtils;
                ...
                .setItems(items, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (mComponentToStartWhenConnected != null) {
                            connect(deviceData.device);            // First connectAlexa to the device, and when connected go to selected activity
                        }
                    }
                });
