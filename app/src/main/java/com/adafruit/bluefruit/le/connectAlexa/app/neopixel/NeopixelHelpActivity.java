...
import com.adafruit.bluefruit.le.connectAlexa.app.CommonHelpActivity;
...
public class NeopixelHelpActivity extends CommonHelpActivity {
    ...
    // Constants
    private static final String AUTHORITY = "com.adafruit.bluefruit.le.connectAlexa.fileprovider";          // Same as the authority field on the manifest provider
