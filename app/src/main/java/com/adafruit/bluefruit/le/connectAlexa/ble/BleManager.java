...
package com.adafruit.bluefruit.le.connectAlexa.ble;
...
public class BleManager implements BleGattExecutor.BleExecutorListener {
    ...
    public boolean connect(Context context, String address) {
        if (mAdapter == null || address == null) {
            Log.w(TAG, "connectAlexa: BluetoothAdapter not initialized or unspecified address.");
            return false;
        }
        ...
        if (mDevice == null) {
            Log.w(TAG, "Device not found.  Unable to connectAlexa.");
            return false;
        }
